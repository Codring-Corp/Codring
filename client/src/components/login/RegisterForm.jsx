    ...
    return (
        <div>
            <form onSubmit={handleSubmit(onSubmit)} className={css.form}>
                <h3 className={css.formTitle}>Inscription</h3>
                ...
                <div className={`${css.inputGroup} ${errors.username ? css.errorInputGroup : undefined}`}>
                ...
                <input type="submit" value='Inscription' className={css.submitBtn} />
            </form>
        </div>
    )
}
